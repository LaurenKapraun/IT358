...
//  TabbedAppWithSearchOnTable
//
//  Created by Kapraun, Lauren on 2/10/20.
...
class TeamTableViewController: UITableViewController,  UISearchResultsUpdating {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        if let searchText = searchController.searchBar.text, !searchText.isEmpty {
            ...
            //Closure = An Unnamed Function
            //In Java = Anonymous Function
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let team = unfilteredNFLTeams[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        //print("You picked \(self.unfilteredNFLTeams[indexPath.row])")
